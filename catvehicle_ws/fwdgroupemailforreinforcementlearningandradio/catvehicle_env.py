...
class CATVehicleEnv(robot_gazebo_env.RobotGazeboEnv):
    ...
    def __init__(self):
        ...
        * /kobuki/laser/scan: Laser Readings
        ...
        rospy.Subscriber("/catvehicle/distanceEstimatorSteeringBased/dist", Float64, self.dist)
        rospy.Subscriber("/catvehicle/distanceEstimatorSteeringBased/angle", Float64, self.angle)
