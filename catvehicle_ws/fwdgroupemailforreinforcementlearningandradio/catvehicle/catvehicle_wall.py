...
class CATVehicleWallEnv(catvehicle_env.CATVehicleEnv): # change location
    def __init__(self):
        ...
        super(CATVehicleWallEnv, self).__init__() #change to catvehicle name
        ...
        high = numpy.full((self.n_observations), self.max_sensor_value)
        low = numpy.full((self.n_observations), self.min_sensor_value)
        ...
        self.laser_filtered_pub = rospy.Publisher('/catvehicle/laser/scan_filtered', LaserScan, queue_size=1)
