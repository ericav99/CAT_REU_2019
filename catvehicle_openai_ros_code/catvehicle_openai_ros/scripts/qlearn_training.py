...
from catvehicle.scripts import run_sim
...
if __name__ == '__main__':
    ...
    for x in range(nepisodes):
        ...
        # env.render()
        # for each episode, we test the robot for nsteps; nstep CAPPED by timestep_limit in task env
        ...
        # Close the world and environment, prepare to reset
        sim.signal_handler(2) # Ctrl + C the program
        env.close()
